...
打包配置会内置 `assets/` 下的 Tabler 衍生窗口图标、第三方许可、重启助手和 GLM `models.json`。安装注入使用独立的 `models-glm.json`，避免污染 GPT 中转的模型目录。单文件产物为 `outputs/codex_api_provider_switch/Codex Provider Switch-1.3.4.exe`，安装包为同目录下的 `Codex Provider Switch-Setup-1.3.4.exe`。安装版支持系统托盘常驻和可选开机后台监控。版本号的运行时事实源为 `provider_switch/constants.py`，Windows 文件版本由 `assets/version_info-1.3.4.txt` 提供。
...
1.3.1 产物 SHA-256：便携版 `0674EBB245283ED2DD634DA57572C241237826F94664837B68E8BEFD9BDCAABA`；安装包 `4BCF1281A7240B67A631330CA460F4F6A9777B56D69821A71A0EE52C5BCD1B4C`。1.3.2 产物 SHA-256：便携版 `A95C6A2014836ED69D5385ADB3C7A29E855EF43F7BA765CC8F9DF74B7A30EA90`；安装包 `64FA18D555F46C2710C5BA1EF458265265A077D6FB983E48D922EE5EC9147932`。1.3.3 产物 SHA-256：便携版 `E08DCCAB83F6ACFDD545A94BD51FA8A18805AC66F09263856A3F19B65DFB632C`；安装包 `19146F465EB01E6286C0D873FBA96F1428E3DD8CD69B629FB7A2C06895083325`。1.3.4 产物 SHA-256：便携版 `C27678B87C5BFEB1E855C38246E74D8A84323A832A0992A4D67259D94F1C3B9F`；安装包 `8D574E678B99482DC44E0D45C1015B302ED19C81FC2ECE43416536782E2D3112`。
...
监控面板不再显示供应商可用性时间线或条形监控区域；只展示基于 Codex 实际请求记录计算的可用性、错误率、平均首响应时间和 Token 仪表盘。刷新只读取本地记录，不会定时探测未使用的供应商。
