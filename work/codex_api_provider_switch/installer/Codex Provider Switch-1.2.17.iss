...
#define MySetupName "Codex Provider Switch-Setup-1.2.17"
#define SourceExe "..\..\..\outputs\codex_api_provider_switch\Codex Provider Switch-1.2.17.exe"
