...
#define MySetupName "Codex Provider Switch-Setup-1.2.25"
#define SourceExe "..\..\..\outputs\codex_api_provider_switch\Codex Provider Switch-1.2.25.exe"
