...
#define MySetupName "Codex Provider Switch-Setup-1.2.24"
#define SourceExe "..\..\..\outputs\codex_api_provider_switch\Codex Provider Switch-1.2.24.exe"
...
WizardStyle=modern
; The app normally closes to the tray.  Restart Manager's graceful close
; therefore leaves a hidden process behind and makes setup wait indefinitely.
; Force termination here is limited to this executable by the filter below.
CloseApplications=force
CloseApplicationsFilter=Codex Provider Switch.exe
RestartApplications=no
VersionInfoVersion=1.2.24.0
